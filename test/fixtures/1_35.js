...
tape('type: "Buffer10"', t => {
  const { valid, invalid } = tests(t, TYPES['Buffer10'])
  ...
  invalid({
    exception: 'Expected _Buffer\\(Length\\: 10\\), got _Buffer\\(Length\\: 0\\)',
    valueId: 'Buffer'
  }),
  invalid({
    exception: 'Expected _Buffer\\(Length\\: 10\\), got _Buffer\\(Length\\: 3\\)',
    valueId: 'Buffer3'
  }),
