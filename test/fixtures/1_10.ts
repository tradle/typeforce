...
const fix = fixture('1_10 - "{ a: Number|{ b: Number } }"', (types: { [key: string]: any }) => types['{ a: Number|{ b: Number } }'], ({ valid, invalid }) => {
  valid({ value: { a: 0 } })
  ...
  invalid({ exception: 'Expected property "a" of type Number|Object, got undefined', value: [] })
  invalid({ exception: 'Expected property "a" of type Number|Object, got undefined', value: [ 0 ] })
  invalid({
  ...
  invalid({ exception: 'Expected property "a" of type Number|Object, got undefined', value: {} })
  invalid({ exception: 'Expected property "a" of type Number|Object, got null', value: { a: null } })
