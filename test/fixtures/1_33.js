...
const fix = fixture('"Buffer0"', TYPES['Buffer0'], ({ valid, invalid }) => {
  ...
  invalid({
    exception: 'Expected _Buffer\\(Length\\: 0\\), got _Buffer\\(Length\\: 3\\)',
    valueId: 'Buffer3'
  })
  invalid({
    exception: 'Expected _Buffer\\(Length\\: 0\\), got _Buffer\\(Length\\: 10\\)',
    valueId: 'Buffer10'
  })
