...
const fix = fixture('1_33 - "Array6"', (types: { [key: string]: any }) => types['Array6'], ({ valid, invalid }) => {
  ...
  invalid({ exception: 'Expected Array\\(Length\\: 6\\), got Array\\(Length\\: 0\\)', value: [] })
  invalid({ exception: 'Expected Array\\(Length\\: 6\\), got Array\\(Length\\: 1\\)', value: [ 0 ] })
  invalid({
    exception: 'Expected Array\\(Length\\: 6\\), got Array\\(Length\\: 1\\)',
    value: [ 'foobar' ]
  })
  invalid({
    exception: 'Expected Array\\(Length\\: 6\\), got Array\\(Length\\: 1\\)',
  ...
  invalid({
    exception: 'Expected Array\\(Length\\: 6\\), got Array\\(Length\\: 5\\)',
    valueId: 'Array5'
  })
  invalid({
    exception: 'Expected Array\\(Length\\: 6\\), got Array\\(Length\\: 7\\)',
    valueId: 'Array7-N'
  })
  invalid({
    exception: 'Expected Array\\(Length\\: 6\\), got Array\\(Length\\: 7\\)',
