...
module.exports = {
  ...
  invalid: [
    ...
    { exception: 'Expected Number, got Boolean false', value: false },
    { exception: 'Expected Number, got Boolean true', value: true },
    { exception: 'Expected Number, got undefined', value: undefined },
    ...
    { exception: 'Expected Number, got Object', value: { a: 0, b: 0 } },
    ...
    { exception: 'Expected Number, got Function', valueId: 'function' },
    {
    ...
    { exception: 'Expected Number, got Object', valueId: '{ x: 1 }' },
    { exception: 'Expected Number, got Object', valueId: '{ y: 2 }' },
    {
      exception: 'Expected Number, got Object',
      valueId: '{ x: 1, y: 2 }'
    },
    ...
    { exception: 'Expected Number, got Buffer', valueId: 'Buffer10' },
    {
