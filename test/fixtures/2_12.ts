...
const fix = fixture('2_12 - [{"a":"Number"}]', () => ([ { a: 'Number' } ]), ({ valid, invalid }) => {
  valid({ value: [] })
  ...
  invalid({ exception: 'Expected property "0" of type Object, got null', value: [ null ] })
  ...
  invalid({ exception: 'Expected property "0" of type Object, got String "a"', valueId: 'Array6-S' })
