...
const fix = fixture('1_27 - "{ x: Number } & { y: Number }"', (types: { [key: string]: any }) => types['{ x: Number } & { y: Number }'], ({ valid, invalid }) => {
  ...
  invalid({ exception: 'Expected Object|Object, got Object', valueId: '{ a: { b: Buffer3 } }' })
  invalid({ exception: 'Expected Object|Object, got Object', valueId: '{ a: { b: Buffer10 } }' })
