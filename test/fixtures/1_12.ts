...
const fix = fixture('1_12 - "{ a: ?{ b: ?{ c: Number } } }"', (types: { [key: string]: any }) => types['{ a: ?{ b: ?{ c: Number } } }'], ({ valid, invalid }) => {
  valid({ value: [] })
  ...
  invalid({ exception: 'Unexpected property "a\\.0"', strict: true, valueId: '{ a: Buffer3 }' })
  invalid({ exception: 'Unexpected property "a\\.0"', strict: true, valueId: '{ a: Buffer10 }' })
  invalid({
